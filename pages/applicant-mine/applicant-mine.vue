<template>
  <view class="applicant-mine">
    <!-- 顶部操作栏 -->
    <view class="top-bar">
		<view class="icon-wrapper">
			<image src="/static/applicant-mine/applicant-mine/setting.png" mode="aspectFit" @click="openSettings"></image>
		</view>
		<view class="icon-wrapper">
			<image src="/static/applicant-mine/applicant-mine/mail.png" mode="aspectFit" @click="openMessages"></image>
		</view>
    </view>
...
export default {
  ...
  methods: {
	...
	navigateToStats(route) {
		uni.navigateTo({
			url: `/pages/applicant-mine-${route}/applicant-mine-${route}`
		})
	},
...
.applicant-mine {
  ...
  background-image: url('/static/applicant-mine/applicant-mine/bgc-mine.png'); /* 设置背景图像 */
