	...
	<view class="offerList">
		...
		<view class="header">
			<view class="user-avatar">
				<image src="../../static/hr-index/user.png" style="width: 48rpx; height: 48rpx;"></image>
			</view>
			<!-- 顶部搜索栏 -->
			<view class="search-bar">
			 ...
			 <view class="message-icon">
				 <image src="../../static/hr-index/Mail.png" style="width: 48rpx; height: 48rpx;"></image>
			 </view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			gotoAppliDetails() {
				uni.navigateTo({
					url:'/pages/hr-index/appliDetails'
				})
			},
...
.remain {
	flex: 1;
	flex-direction: column; 
	background-image: url('/static/hr-index/bgc.png'); /* 设置背景图像 */
