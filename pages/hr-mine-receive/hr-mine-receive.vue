	...
	<view class="offerList">
		...
		<view class="header">
			<view style="display: flex; align-items: center;">
				...
				<!-- text -->
				<view class="headerText">收到的简历</view>
			</view>
			...
			<view class="search-bar">
			  ...
			  <view class="search-input">
				<input type="text" placeholder="搜索收到的简历" placeholder-class="placeholder"/>
			  </view>
			</view>
		...
		<view class="remain">
			...
			<view class="job-list-selector">
			  ...
			  <view class="selector-item" :class="{ active: currentSelector === 'newest' }" @click="changeSelector('newest')">最新</view>
